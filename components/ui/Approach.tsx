  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" /> } description="lorem">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development & Launch" icon={<AceternityIcon  order="Phase 3" />} description="lorem">
          <CanvasRevealEffect
            animationSpeed={3}
